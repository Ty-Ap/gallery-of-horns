...
class Main extends React.Component{
  render(){
    ...
    <main>
      {data.map((beast) => {
        return <HornedBeast id={beast._id} name={beast.name} image_url={beast.image_url} description={beast.description} 
        keyword={beast.keyword} hornNum={beast.horns} title={beast.title}/>
      }
      )}
    </main>
      ...
      <HornedBeast id="12" title="Markhor" image_url="https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Markhor_Schraubenziege_Capra_falconeri_Zoo_Augsburg-02.jpg/220px-Markhor_Schraubenziege_Capra_falconeri_Zoo_Augsburg-02.jpg" description="These wild goats eat snakes, then secrete a foam that locals fight over for the antivemon properties -- how cool is that?" />
      <HornedBeast id="13" title="Baby markhor" image_url="http://www.zooborns.com/.a/6a010535647bf3970b0223c84d5959200c-800wi" description="Even the babies are adorable" />
      <HornedBeast id="14" title="Mouflon" image_url="https://images.unsplash.com/photo-1558560063-931ca9822a0c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80" description="Those horns though" />
      <HornedBeast id="15" title="Addax" image_url="https://images.unsplash.com/photo-1556890077-020ec300d5db?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1353&q=80" description="This guy is basically extinct but survives well in captivity, so they're frequently found in zoos" />
      <HornedBeast id="16" title="Baby mouflon" image_url="https://cbsnews3.cbsistatic.com/hub/i/r/2013/03/05/5b414225-a645-11e2-a3f0-029118418759/thumbnail/620x350/2d4cf24685b45c22912e64d2004fec8d/Baby_Mouflon_Wild_Sheep.jpg" description="The cuteness that is a baby mouflon asleep" />
      <HornedBeast id="17" title="Happy Jackson's Chameleon" image_url="https://images.unsplash.com/photo-1514036783265-fba9577fc473?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" description="These are really common in Hawaii" />
      <HornedBeast id="18" title="Serious Jackson's Chameleon" image_url="https://imgc.allpostersimages.com/img/print/posters/dlillc-jackson-s-chameleon_a-G-13448768-14258384.jpg" description="This one is very serious." />
      <HornedBeast id="19" title="Horned Lizard" image_url="https://www.nps.gov/band/learn/nature/images/short-horned-lizard-open-mouth-18.jpg?maxwidth=650&autorotate=false" description="Fave food: ants" />
      <HornedBeast id="20" title="Smaug" image_url="https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Smaug_par_David_Demaret.jpg/290px-Smaug_par_David_Demaret.jpg" description="Fan illustration of Smaug from 'The Hobbit'" /> */}
